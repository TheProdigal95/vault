...
but do not stop the import.`,
  ...
  motion-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  motion-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | motion-pp-cli import <resource> --input -`,
