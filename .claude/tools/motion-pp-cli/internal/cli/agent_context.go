...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://projects.motionapp.com/organization/6214fe5e1ccc60d23897d87b/697a256b66437695f674687d",
		EntryCount:    83,
		APIEntryCount: 82,
		...
		Warnings: []string{
			...
			"empty_payload: API-looking request returned an empty or null payload; schema confidence is weak.",
			"empty_payload: API-looking request returned an empty or null payload; schema confidence is weak.",
			"graphql_error_only: GraphQL response contains errors without data; captured operation may not represent successful behavior.",
		},
		CandidateCommands: []string{
			"create_getGroupedAdsMetaInsightsV2 — Derived from observed POST /api/v2/insights/getGroupedAdsMetaInsightsV2 traffic.",
			"create_graphql — Derived from observed POST /graphql traffic.",
			"create_token — Derived from observed POST /api/builder-agent/token traffic.",
			"list_en — Derived from observed GET /api/product-config/locales/projects.motionapp.com/widget/en/v2 traffic.",
			"list_getAdCommentsByCreativeAssetWeb — Derived from observed GET /api/v2/creative/getAdCommentsByCreativeAssetWeb traffic.",
		},
	}
}
