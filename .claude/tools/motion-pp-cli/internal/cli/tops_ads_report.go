...
func newTopsAdsReportCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "ads-report",
		Short:       "Fetch tops ads report",
		Example:     "  motion-pp-cli tops ads-report --operation-name example-resource",
		Annotations: map[string]string{"pp:endpoint": "tops.ads_report", "pp:method": "POST", "pp:path": "/graphql"},
