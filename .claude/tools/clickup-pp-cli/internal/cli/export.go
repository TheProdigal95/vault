...
large datasets as it has no memory pressure.`,
  ...
  clickup-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  clickup-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  clickup-pp-cli export <resource> --format jsonl | jq '.id'`,
