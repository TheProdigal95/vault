...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "motion-pp-cli",
		Short: "Manage motion resources via the motion API",
		Long: `Manage motion resources via the motion API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'motion-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("motion-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'motion-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDatasCmd(flags))
	rootCmd.AddCommand(newGlossariesCmd(flags))
	rootCmd.AddCommand(newHasCmd(flags))
	rootCmd.AddCommand(newOrganizationsCmd(flags))
	rootCmd.AddCommand(newProductConfigCmd(flags))
	...
	rootCmd.AddCommand(newAnglesCmd(flags))
	rootCmd.AddCommand(newFormatsCmd(flags))
	rootCmd.AddCommand(newHighlightsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAisPromotedCmd(flags))
	rootCmd.AddCommand(newAvailablesPromotedCmd(flags))
	rootCmd.AddCommand(newBootstrapsPromotedCmd(flags))
	rootCmd.AddCommand(newBrandsPromotedCmd(flags))
	rootCmd.AddCommand(newBuilderAgentPromotedCmd(flags))
	rootCmd.AddCommand(newCreativePromotedCmd(flags))
	rootCmd.AddCommand(newCustomsPromotedCmd(flags))
	rootCmd.AddCommand(newDefaultsPromotedCmd(flags))
	rootCmd.AddCommand(newDisplaysPromotedCmd(flags))
	rootCmd.AddCommand(newFacebooksPromotedCmd(flags))
	rootCmd.AddCommand(newInsightsPromotedCmd(flags))
	rootCmd.AddCommand(newIsPromotedCmd(flags))
	rootCmd.AddCommand(newMessagingsPromotedCmd(flags))
	rootCmd.AddCommand(newOrganizationPromotedCmd(flags))
	rootCmd.AddCommand(newSharedsPromotedCmd(flags))
	rootCmd.AddCommand(newSignalPromotedCmd(flags))
	rootCmd.AddCommand(newSlacksPromotedCmd(flags))
	rootCmd.AddCommand(newTrialsPromotedCmd(flags))
	rootCmd.AddCommand(newVerifiesPromotedCmd(flags))
