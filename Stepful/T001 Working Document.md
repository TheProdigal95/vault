...
cssclasses:
  ...
  - wide
---
# T001 — Stepful Meta Statics + Text Wall

---

## Raw Notes — Batch Strategy

> From strategist observations on [[2026-06-02 Top Spenders Analysis - T001]] and batch planning discussion.
...
- #16 (CPHT DITL THISISYOURSIGN) is not a talking head — it's UGC-style b-roll with music + on-screen captions. A montage a working mom could make. Explore this format
- The "at-home clinical kit" should be called out that way — make it clear you receive it at home
...
- No video shoots — everything is statics, carousels, text wall over sourced b-roll, montage + captions
- No AI UGC (doesn't look good enough)
- No Reddit/Tweet native screenshots (Twitter skews male, wrong audience)
- No standalone VoC editorial quotes — fold social proof into other formats where it fits
...
**Product:** Stepful CCMA (Medical Assistant) + CPHT (Pharmacy Technician)
**Product pages:** stepful.com/medical-assistant, stepful.com/pharmacy-tech
**Platform:** Meta
**Personas:** Affordable Fast-Track Seeker, Dead-End Job Escaper, Life-Circumstances Career Launcher
**Batch size:** 15 ads (11 CCMA / 4 CPHT)

**Representation:**
- Black women: primary talent in 7-8 concepts — text walls, montages, comment replies
- Asian women: 2 concepts — mom angles (#6, #8), matching Jane #13's 8.18% CTR pattern
- Latina/mixed women: 2-3 concepts — CPHT angles, DITL-style
- No person shown: 4-5 concepts — infographics, carousels, comparison statics
...
> 3 hooks per concept. Every hook follows the quality bar: first person, specific numbers, emotional tension, clear picture, payoff promise. See [[2026-06-02 Top Spenders Analysis - T001]] for the account patterns these are grounded in.

### #1 — CCMA 2-Month Cert Progression

| | Hook |
|---|---|
| A | How to get a healthcare certification in just 2 months |
| B | I got OSHA & HIPAA certified in 2 months — now I work in healthcare. |
| C | By month 2 I was already certified in OSHA & HIPAA. By month 5 I was a certified Medical Assistant. Here's the full timeline. |

### #2 — CPHT 4-Month Cert Progression

| | Hook |
|---|---|
| A | I became a certified pharmacy tech in 4 months. Here's what each month looked like. |
| B | Zero experience to certified pharmacy tech. It took 4 months. |
| C | Here's how you can start working in healthcare in just 4 months with 0 experience |

### #3 — CCMA Stepping Stone
...
|---|---|
| A | How to get a healthcare certification in just 2 months |
| B | Most people think breaking into healthcare takes years. It took me 2 months to get my first cert. |
| C | I had my first healthcare certification before I was even halfway through the program. Here's what the first 2 months look like. |

### #13 — 6 Figures No Degree Carousel
...
| | Hook |
|---|---|
| A | Everyone overcomplicates breaking into healthcare. It's 3 steps. |
| B | Stop overthinking it. Here's how you become a medical assistant. |
| C | 3 steps between you and a healthcare career. Seriously. |

### #15 — Healthcare Role Quiz

| | Hook |
|---|---|
| A | Ask your besties which healthcare role you are |
| B | Tag the friend who's been talking about switching careers. This is her sign. |
| C | Which healthcare career are you? Take the quiz — then check if your bestie got the same one. |

---

## Concept Validation

> Each concept tested against the 7-test quality bar. Then batch-level differentiation rule.

### 7-Test Results

| # | Concept | 1. Pain | 2. Coherence | 3. Differentiation | 4. Format | 5. Hook | 6. Hypothesis | 7. Producible | Verdict |
|---|---|---|---|---|---|---|---|---|---|
| 1 | CCMA 2-Month Cert Progression | ✅ "Healthcare takes years" tension | ✅ | ✅ OSHA/HIPAA 2-month angle is Stepful-specific | ✅ Timeline for Goal Gradient | ✅ | ✅ Goal Gradient is #1 heuristic in top performers | ✅ | PASS |
| 2 | CPHT 4-Month Cert Progression | ✅ Same time tension, CPHT | ✅ | ✅ CPHT milestones | ✅ | ✅ | ✅ Tests CCMA finding on CPHT | ✅ | PASS |
| 3 | CCMA Stepping Stone | ✅ "I need a degree" belief | ✅ | ✅ Stepping stone angle unique to Stepful's position | ✅ Comparison for Framing Effect | ✅ | ✅ #10 converts on framing; $49 vs $20K makes it visceral | ✅ | PASS |
...
| 11 | Comment Reply CPHT | ✅ "Is this legit?" — skepticism | ✅ | ✅ CPHT + skeptic angle distinct from #10 | ✅ | ✅ Skeptic-to-believer | ✅ Core converting archetype per Elevate learnings | ✅ | PASS |
| 12 | 2-Month Cert Carousel | ✅ Same time tension as #1 | ✅ | ✅ Different format tests same hook | ✅ Proven carousel format (3.62 ROAS) | ✅ | ✅ Hook × format test: carousel vs timeline | ✅ | PASS |
| 13 | 6 Figures No Degree Carousel | ✅ Same income tension as #9 | ✅ | ✅ Fresh execution of account's best performer | ✅ | ✅ "So I'm telling you" = fresh angle | ✅ Iterate #10 (3.62 ROAS, 6.30% CTR) | ✅ | PASS |
| 14 | 3 Steps to MA Career | ✅ "Healthcare feels overwhelming" | ✅ | ✅ 3-step frame unique in batch | ✅ Infographic for Processing Fluency | ✅ Provocation + simplification | ✅ Processing Fluency drives top-converting statics | ✅ | PASS |
| 15 | Healthcare Role Quiz | ⚠️ Weak — engagement-first, not pain-built | ✅ | ✅ Quiz is unique format | ✅ Proven format (#9, 3.40 ROAS) | ⚠️ Engagement bait, not tension | ✅ Proven ROAS; different purpose (funnel entry) | ✅ | FLAG |

**#15 flag mitigation:** The quiz format serves a different batch function — engagement/shareability as a funnel entry point, not direct conversion. #9 in the account proves 3.40 ROAS with this format. The pain specificity is weak ("I don't know which career fits me") but the format's proven performance justifies the slot. Accepted with flag.

### Differentiation Rule

Each concept must shift at least 2 of 4 axes (persona, messaging angle, format, hook tactic) from every other concept.
...
| #5 vs #6 vs #7 | All different | All different | Same (text wall) | All different | 2+ | ✅ PASS |

**Verdict on flagged pairs:** #1/#12 and #9/#13 are deliberate hook × format tests — they share a hook to isolate format as the variable. #1/#2 and #3/#4 share format + angle to isolate program (CCMA vs CPHT) as the variable. All four pairs are accepted as intentional test designs, not creative laziness.

### Overall Validation: ✅ PASS

- 14 of 15 concepts pass all 7 tests
- 1 concept (#15) flagged on pain specificity — accepted with mitigation (proven format, different batch function)
- 4 pairs flagged on differentiation rule — all accepted as intentional variable isolation tests (hook × format, CCMA × CPHT)

---

## Visual Style Guide — From Gemini Analysis

> Gemini analysis run on 15 video source files + carousel source images from Motion CDN. Raw per-ad breakdowns at [[Gemini Visual Analysis - Top 20]]. These specs are the synthesized reference for all Visual Direction and Image Direction sections in this batch.

### Cross-Video Patterns (from 15 analyzed videos)

**Edit pace — universal across ALL top 20 videos:**
- 1.0-2.5 second cuts. Montages faster (1.0-1.5s), talking heads alternate 2-3s face holds with 1-1.5s inserts
- EXCLUSIVELY hard cuts. Zero dissolves, wipes, or transitions in any of the 15 videos analyzed
- Pace structure: slightly longer opening shot to establish (2-3s) → rapid b-roll middle → longer close for resolution/CTA (3-4s)

**Camera — universal:**
- All handheld phone-shot. Selfie cam for talking heads, handheld POV for b-roll
- Natural micro-jitters are universal. Never stabilized, never gimbal, never tripod (exception: #5 uses stock footage but still performs)
- MCU framing for faces, CU/ECU for inserts. No wide shots. Everything is intimate and close
- 1080p phone quality — crisp but no cinematic depth of field

**Lighting — the before→after shift:**
- Talking head: soft natural window light from side/front
- Clinical b-roll: cool overhead fluorescent (the real lighting of hospitals/clinics)
- Home/study scenes: warmer indoor lamp + laptop screen glow
- "Before" scenes (#14, #20): deliberately unflattering harsh fluorescent (retail counter, boring office). Cool-toned, flat
- "After" scenes: brighter, warmer, more optimistic. Natural window light, clean clinical white
- This lighting shift is a visual storytelling device — unflattering light = old life, warm/bright light = new life

**Color grade — universal:**
- Neutral-to-cool, moderately saturated, no filters, glossy not matte
- Bright and punchy enough for mobile screens, never desaturated or vintage
- White balance shifts naturally between warm (home/car) and cool (clinical) — this is authentic, not graded

**Caption styles — two modes:**
- **With VO (talking head format):** White text in semi-transparent black rounded rect, karaoke/word-by-word reveal synced to voice. Sentence case. 1-2 lines. Emoji for transitions (✈️ ➡️ 💉 ✅ 🎓)
- **No VO (montage format):** Same white-on-black style but text punches/pops in with each hard cut. ALL CAPS for key facts. Sentence case for narrative. Emoji as visual punctuation (✅, 💰, 🎓, 🩺)

**Audio — universal:**
- Upbeat, optimistic, motivational instrumental pop. No lyrics. Simple melody + steady mid-tempo beat
- VO (when present): casual female, phone-mic quality, slight room reverb. Never studio-polished. Energetic, friendly, conversational
- Music ducked significantly under VO when present. Full volume when no VO
- No sound effects in any of the 15 videos

**B-roll vocabulary — the recurring shots (frequency across 15 videos):**
- Laptop/phone showing Stepful website (ECU insert) — 12 of 15 videos
- Woman in scrubs at clinical desk/computer (MS) — 9 of 15
- Hands practicing blood draw on training arm (CU/ECU) — 8 of 15
- Writing/highlighting in notebook or textbook (CU) — 7 of 15
- Hand holding certification document (CU) — 6 of 15
- Walking down clinical hallway in scrubs (MS) — 5 of 15
- Selfie-cam in car with natural window light (MCU) — 5 of 15
- Screen recording of app/course module scrolling (ECU) — 4 of 15
- "Before" scene: bored at desk, retail counter, unflattering light (MS) — 3 of 15
- Group of healthcare workers smiling together (MS) — 3 of 15
- Hands opening sterile medical package (ECU) — 3 of 15
- Blood pressure cuff on patient's arm (CU) — 2 of 15
- Clinical kit items laid out on counter/table (CU) — 2 of 15

### Video: B-Roll Montage + Captions (no VO)

*Reference: #16 MOM_PAYOFF, #5 160_CLINICAL_HOURS, #8 DA_THISISYOURSIGN, #11 NASH_DRAKEAUDIO, #14 CPHT_EXTERNSHIP, #20 PASSED_FIRST_TRY*

All cross-video specs above apply. Format-specific:
- 9:16 vertical, 9-18 seconds total
- Fastest edit pace of any format: 1.0-1.5s average cuts
- Text pops in synced with each hard cut. One idea per shot
- Music at 100% — it's the only audio element and sets the emotional energy
- The "before → after" lighting shift works especially well here (#14, #20 use it deliberately)

### Video: Text Wall + Inspirational Audio

*Reference: Elevate's Shame to Pride Selfie Walk ($301 CPP, 3.07 ROAS, Hold 79)*

All cross-video specs above apply for b-roll style. Format-specific:
- 9:16 vertical, 15-30 seconds
- Slower cuts than montage: 2-4 seconds per shot. Text is the focus, not the visuals
- B-roll is atmospheric — sets mood, not story. Kitchen table studying, clinical hallway, morning light, coffee cup, stethoscope on desk
- Text appears in blocks (1-3 lines), synced to audio beats. Same white-on-black style
- Shame-to-pride arc: struggle opening → transformation → payoff
- IG-sourced inspirational audio with music drives emotional completion. The audio is as important as the visual

### Video: UGC Talking Head + B-roll (with VO)

*Reference: #3 NASH_DITL, #4 MYAH_4REASONS, #6 KIARA_TESTIMONIAL, #12 KIARRA_PHLEBOTOMY, #13 JANE_MOM, #17 HONESTREVIEW, #18 HANNAH_LANDEDJOB*

All cross-video specs above apply. Format-specific:
- 9:16 vertical, 18-30 seconds
- Alternates talking head (2-3s) and b-roll inserts (1-1.5s)
- Primary A-roll locations: in a car (5 of 7 use this), at home, in clinic
- Phone-mic VO with room reverb is the authenticity signal. Never clean audio
- Karaoke caption sync to VO — words appear as speaker says them
- The car selfie is the dominant A-roll setting for this format

### Static: Carousel — Swipe-to-Learn / Guide Format

*Reference: #10 SIXFIGURES_CAROUSEL (3.62 ROAS, 6.30% CTR) — all 5 slides analyzed from source images*

**Design system:**
- **Background:** Warm cream/beige (#F5F0E8)
- **Headline font:** Dark navy transitional serif (Playfair Display or similar), large, dominant
- **Body font:** Clean sans-serif, regular weight, justified or left-aligned
- **Accent color:** Coral/salmon pink (#F5A0A3) — highlight blocks behind key headline words
- **Secondary accent:** Soft green (#A8D8A0) for salary/earning number pills
- **Brand mark:** "Stepful" in navy serif, top center (slide 1) or bottom center (inner slides)

**Slide 1 (Cover):** Cream bg, big serif headline with pink highlights, collage of cutout images (medical tools + luxury aspirational items: designer bag, cash, perfume). Woman in pink scrubs mirror selfie. "Swipe to get the full guide." — the aesthetic is "girly healthcare money"

**Inner slides:** Cream bg + soft pink gradient at top. Navy serif title. White rounded-corner card with pink dotted border: heading, description, green salary pill. One idea per slide.

**Final slide (CTA):** "Comment CAREER to get the full guide." Key word highlighted pink. Fresh luxury collage.

### Static: Quiz / Personality Format

*Reference: #9 which-healthcare-role (3.40 ROAS, 3.13% CTR)*

- Same cream/beige background, pink accessories collage, navy serif text
- The items ARE the quiz — each represents a role/personality type

### General Static Rules (All Formats)

- **Never clinical/sterile.** Warm, feminine, Pinterest/Canva-native
- **Navy serif for headlines, sans-serif for body**
- **Pink highlight blocks** behind key words
- **Cream/beige backgrounds** — never white, never dark
- **Cutout collage style** for cover/CTA slides: medical tools + aspirational lifestyle items
- **No heavy branding.** Stepful logo small, top or bottom center

---

## Script Criteria

> **Baseline:** All rules in `00 Global/Criteria/` apply automatically. Read Universal Copy Rules + Video Script Criteria + Creative Image Ad Criteria before writing.
>
> **This section is for Stepful-specific overrides only.**
...
**Compliance (mandatory — from [[Compliance - Stepful]]):**
- Never call the program "certified" or "accredited" — the program prepares you for the certification exam, the program itself is not certified
- No employment guarantees — say "we help you secure" not "we guarantee"
- No externship timing guarantees — use "typically within 1-3 months"
- Money-back guarantee only refers to the 3-day/2-week refund window
...
**Tone:**
- Casual, empowering, accessible. Speaks to women breaking into the workforce
- Deliberate imperfections are OK — abbreviated text, casual grammar, emoji. Don't over-polish
- No corporate healthcare language. Speak like a friend who just went through the program

**Visual direction defaults:**
- Pink/beige/feminine palette — matches account winners
- Girly Canva-style aesthetic for statics. Not clinical/sterile
- Stock b-roll for montage/text wall: clinical settings, studying at kitchen table, woman in scrubs, at-home kit on counter
- "At-home clinical kit" — always describe it as at-home, emphasize receiving it at your door

---

## Process Log

<!-- Before/after examples from iteration. Starts fresh for T001. -->

---

## Context Files for Agents

- [[Brand Context - Stepful]]
- [[Product Context - Stepful]]
- [[Persona Context - Stepful]]
- [[Compliance - Stepful]]
- [[2026-06-02 Top Spenders Analysis - T001]]
- [[T001 Working Document]] (this file)
