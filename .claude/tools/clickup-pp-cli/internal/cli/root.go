...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "clickup-pp-cli",
		Short: "Manage clickup-pp-cli resources via the clickup-pp-cli API",
		Long: `Manage clickup-pp-cli resources via the clickup-pp-cli API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'clickup-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newFootageRequestCmd(flags))
