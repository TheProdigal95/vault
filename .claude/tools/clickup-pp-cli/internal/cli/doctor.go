		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export CLICKUP_API_TOKEN=<your-personal-token>  (or CLICKUP_PP_CLI_BEARER_AUTH)"
				} else {
					authConfigured = true
			...
			if os.Getenv("CLICKUP_API_TOKEN") != "" || os.Getenv("CLICKUP_PP_CLI_BEARER_AUTH") != "" {
				if os.Getenv("CLICKUP_API_TOKEN") != "" {
					authEnvSet = append(authEnvSet, "CLICKUP_API_TOKEN")
				} else {
					authEnvSet = append(authEnvSet, "CLICKUP_PP_CLI_BEARER_AUTH")
				}
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "CLICKUP_API_TOKEN")
			}
			switch {
